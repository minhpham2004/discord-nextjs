...
function ChatItem({ id, content, member, timestamp, fileUrl, deleted, currentMember, isUpdated, socketUrl, socketQuery }: ChatItemProps) {
                    ...
                    }
                    {
                        !fileUrl && !isEditing && (
                            <p className={cn(
                                ...
                                deleted && "italic text-sm text-zinc-500 dark:text-zinc-400 mt-1"
                            )}>
                                {content}
                                {isUpdated && !deleted && (
